...
#include <memory>
#include "../../../App/FileWorker/FileWorker.h"
...
QT_MOC_LITERAL(1, 11, 14), // "setWindowTitle"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 5) // "title"

    },
    "FileWorker\0setWindowTitle\0\0title"
};
...
void FileWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FileWorker::setWindowTitle)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FileWorker::setWindowTitle(const QString & _t1)
{
