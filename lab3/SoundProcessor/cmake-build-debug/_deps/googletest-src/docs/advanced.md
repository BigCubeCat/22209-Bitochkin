...
may begin threads before main is ever reached. Once threads have been created,
...
listen to include the begin and end of the test program, a test suite, or a test
...
catch any kind of unexpected exits of test programs. Upon begin, Google Test
