...
2.  Tests should be well *organized* and reflect the structure of the tested
    ...
    projects and begin to work on a new code base.
...
When using googletest, you begin by writing *assertions*, which are statements
...
You can begin from this boilerplate:
