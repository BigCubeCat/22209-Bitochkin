...
namespace utils {
    ...
    public:
        ...
        static InputIterator getLine(InputIterator, InputIterator, std::string &, char, char);
    ...
    InputIterator IFStream::getLine(
            InputIterator begin, InputIterator end, std::string &result, char delimiterChar, char escapingChar) {
        result.clear();
