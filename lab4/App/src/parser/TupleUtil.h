...
namespace utils {
    std::stringstream &operator>>(std::stringstream &stringStream, std::string &string) {
...
std::tuple<Types...> utils::TupleFromVectorString<Types...>::helper(const std::vector<std::string> &v,
...
template<typename... Types>
std::tuple<Types...> utils::TupleFromVectorString<Types...>::makeTuple(const std::vector<std::string> &v) {
